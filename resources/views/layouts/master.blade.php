...
<head>
  ...
  <body cz-shortcut-listen="true">
    <!-- As a link -->
    <nav class="navbar navbar-bigscreen">
        <a class="navbar-brand" href="#"><img src="{{ asset('img/logo.png') }}" class="logo-bigscreen"/></a>
    </nav>
    <div class="container">
        @yield('content')
    </div>
    <footer class="my-3 pt-3 text-muted text-center text-small bigscreen-footer">
